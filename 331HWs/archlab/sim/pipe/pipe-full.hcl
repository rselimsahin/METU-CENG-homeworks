...
# 2171999
# 
# Added iaddq to instr_valid to make processor recognize iaddq
# 
# Added iaddq to need_regids because iaddq has a register byte
# 
# Added iaddq to need_valC because it has a constant word as the
# first operand
# 
# IADDQ does not have A source
# 
# Added iaddq to srcB because it uses rB as B source (2nd operand)
# 
# Added iaddq to dstE because it uses rB as E destination(result of
# addition)
# 
# IADDQ does not have an M destination because it does not use memory
# 
# Added iaddq to aluA:valC because first operand is its valC
# 
# Added iaddq to aluB:valB Because second operand is its valB
# 
# Condition codes should be updated because iaddq is arith./logical
# operation; thus, added iaddq in set_cc
# 
# I did not make any changes in Memory Stage because iaddq does not 
# make any changes on memory
#
# I did not make any changes in PC Update because it does not make
# any exceptional changes on PC
